                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="back">
                                            <a href="{{ route('shop.product.details',$product->id) }}">
                                                <img src="{{ asset('assets/images/fashion/product/back/2.jpg') }}"
                                                    class="bg-img blur-up lazyload" alt="">
                                            </a>
                                        </div>
                                        <div class="cart-wrap">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="main-price">
                                            <a href="{{ route('shop.product.details',$product->id) }}" class="font-default">
                                                <h5 class="ms-0">{{ $product->short_description }}</h5>
                                            </a>
                                            ...
                                            <h3 class="">
                                                ...
                                                @else
                                                    <del><span>{{ $product->sale_price }}</span></del>
                                                @endif
