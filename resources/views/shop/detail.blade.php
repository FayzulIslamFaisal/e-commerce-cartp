                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            <div>
                                                <img src="../assets/images/fashion/2.jpg" class="img-fluid blur-up lazyload"
                                                    alt="">
                                            </div>
                                            <div>
                                                <img src="../assets/images/fashion/3.jpg" class="img-fluid blur-up lazyload"
                                                    alt="">
                                            </div>
                                            <div>
                                                <img src="../assets/images/fashion/4.jpg" class="img-fluid blur-up lazyload"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="product-box">
                                    ...
                                    <div class="product-details">
                                        <div class="">
                                            <span class="font-light">Category: {{ $ranProduct->category->name }}</span>
                                        </div>
                                        ...
                                        <div class="main-price">
                                            ...
                                            <a href="details.php" class="font-default">
                                                <h5> {{ $ranProduct->name }}</h5>
                                            </a>
                                            <div class="listing-content">


                                                <p class="font-light">
                                                    {{ $ranProduct->short_description }}
                                                </p>
                                            </div>
                                            <h3 class="theme-color">
                                                @if ($ranProduct->sale_price)
                                                    $ {{ $ranProduct->sale_price }}
                                                    <del>$ {{ $ranProduct->regular_price }}</del>
                                                @else
                                                    <del>
                                                        $ {{ $ranProduct->regular_price }}
                                                    </del>
                                                @endif
                                            </h3>
