                                                    ...
                                                    @auth
                                                        ...
                                                        <li>
                                                            <form id="frmLogout" action="{{ route('logout') }}" method="POST">
                                                                @csrf
                                                                <a href="#" onclick="event.preventDefault();document.getElementById('frmLogout').submit();" class="d-block">Logout</a>
                                                            </form>
                                                        </li>
                                                ...
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{ asset('assets/images/fashion/product/front/1.jpg') }}"
